...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.question_text = self.canvas.create_text(150, 125, width=280,  # width is the text wrapper
                                                     text="question",
    ...
    def get_next_question(self):
        ...
        if self.quiz.still_has_questions():
            ...
            self.true_button.config(state="disabled")  # disable buttons
            self.false_button.config(state="disabled")

    def is_answer_true(self):
        correct_answer = "True"
        is_right = self.quiz.check_answer(correct_answer)
